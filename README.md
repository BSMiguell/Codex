...
| `assets/`              | Recursos estáticos compartilhados: `codex.css` (105 KB, 22 raças), `rituals.js` (22 rituais do modal), `transitions.js` (transições de página), `timeline.css`+`timeline-data.js`, subpastas `brand/`, `ornaments/`, `textures/`, `ui/`, `videos/`, ícones (favicon, apple-touch, og-cover) |
| `data/`                | Configs estáticas: `themes.json` (cor/ícone das 22 raças — fonte canônica única) + `characters.schema.json` (schema JSON da API)                                                                                                                                                            |
| `Historia/`            | Lore autoral do mundo (narrativa livre) + `Aetheria_Dados_do_Mundo.md`, a fonte estruturada da API da história (16 regiões, 5 batalhas, 5 celestes, 22 raças, 22 rituais)                                                                                                                   |
...
| `build_historia_api.ps1`   | 2. **OBRIGATÓRIO** — parseia `Historia/Aetheria_Dados_do_Mundo.md` e gera `historia-api.json` (16 regiões, 5 batalhas, 5 celestes, 22 raças, 22 rituais, com validação cruzada raça↔região↔batalha)                                       |
...
9. **assets/rituals.js** — motor de 22 rituais do modal (3 Demônios + 2 Onis + 1 cada em Humanos/Semideuses/Deuses/Monstros/Meio-Sangue + 1 cada em Desconhecidos/Magos/Seres do Vazio/Aspectos/Alvamortos/Canibais/Bárbaros/Amaldiçoados/Akuma-Gani/Bersek)
...
_Última geração: 19/09/2026 22:55 por `build_readme.ps1`. Histórico e pendências: [`Memoria.md`](Memoria.md)._
